...
# =========================================================
# =========================================================
# FULL CONNECTED CODE WITH SHARED TEAM REWARD
# Replace ONLY run_ac_connected() with this version
# =========================================================
...
def run_ac_connected():
    ...
    while not stop():
        ...
        # local states
        # ---------------------------------
        s_main_local = get_main()   # (W,E,N,S,phase)
        s_ab_local   = get_ab()     # (W,E,S,phase)
        ...
        # total queue + balance penalty
        team_reward = -(q_total + 0.3 * abs(q_main - q_ab))
    ...
    print("Connected shared-reward model saved")
